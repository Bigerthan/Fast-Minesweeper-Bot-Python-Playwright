...
After you run the code and choose the difficulty, chrome browser and then the website will (https://minesweeperonline.com) open.
Because I haven't added First_click funcion to make the bot to start you need to click a cell/box.
Press "R" to Pause/Resume --- Press "ESC" to CLOSE program.
When you calling the bot you might want to check you'r computer's DPI (Dots Per Inch) in settings otherwise the clicking function might click wrong place. Because I'm on laptop, my DPI is 1.25 (default).
